...
namespace QAQCSAP
{
    public partial class QAQCForm : System.Windows.Forms.Form
    {
        ...
        {
            FilenameText.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
            OFDButton.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
        }
        #endregion
        ...
        {
            ElementIDText.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
            SelectElementButton.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
        }
        #endregion
        ...
        #region SAPID Text Box
        /// <summary>
        /// RAMID Textbox changes
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SAPIDText_TextChanged(object sender, EventArgs e)
        {
            SAPIDText.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SAPIDText_Click(object sender, EventArgs e)
        { 
            ResetDefaultTextBoxes(this);

            if (SAPIDText.Text == SAPIDText.Tag.ToString())
            {
                SAPIDText.Text = "";
            }
        }
        ...
        {
            ToleranceText.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
        }
        #endregion
        ...
        {
            RotText.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
        }
            ...
            foreach (System.Windows.Forms.Control control in form.Controls)
            {
                ...
                if (control is System.Windows.Forms.TextBox)
                {
                    ...
                    if (!textBox.Focused && (string.IsNullOrWhiteSpace(textBox.Text)))
                    {
                        ...
                        textBox.ForeColor = System.Drawing.Color.FromArgb(0, 0, 0);
                    }
                }
            }
        }
