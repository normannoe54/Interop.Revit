...
namespace QAQC
{
    ...
    public class ExternalEventRun : IExternalEventHandler
    {
        ...
        public void Execute(UIApplication uiapp)
        {
            ...
            #region Label category sets (Structural Framing, Columns, VB) DO WE NEED THIS?
            ...
            List<string> SPelementstext = new List<string>();

            //Group List constructors
            //List<DefinitionGroup> SPgroups = new List<DefinitionGroup>();
            //List<string> SPgroupstext = new List<string>();

            //Definition List constructor
            //List<Definition> SPdefinitions = new List<Definition>();
            //List<string> SPdefinitionstext = new List<string>();
            ...
            //{
            //    //Clear Lists
            //    SPelementstext.Clear();
            //    SPgroups.Clear();
            //    SPgroupstext.Clear();
            //    SPdefinitions.Clear();
            //    SPdefinitionstext.Clear();

            //    //Iterate this to automatically update
            //    DefinitionFile SP_DefFile = app.OpenSharedParameterFile();

            //    //write all the sharedparameters to strings
            //    foreach (SharedParameterElement SPelement in shParamElements)
            //    {
            //        SPelementstext.Add(SPelement.Name);
            //    }

            //    //If the parameter doesn't exist
            //    if (!ProjectParameterList.Contains(parametername))
            //    {
            //        //If there is no specified shared parameter file
            //        if (SP_DefFile == null)
            //        {
            //            //Create Text File for sharedparameter
            //            System.IO.FileStream fileStream = System.IO.File.Create(sharedParameterFile);
            //            fileStream.Close();
            //            SP_DefFile = app.OpenSharedParameterFile();

            //            //create the group
            //            DefinitionGroup QAQCgroup = SP_DefFile.Groups.Create(groupname);

            //            //write the parameters
            //            #region write definitions and parameters

            //            //Create shared parameter definitions in shared parameter text file
            //            ExternalDefinitionCreationOptions OptionDefinition = new ExternalDefinitionCreationOptions(parametername, ParameterType.Text);
            //            QAQCgroup.Definitions.Create(OptionDefinition);
            ...
            //        //If there is a shared parameter file specified
            //        else
            //        {
            //            //create a list of all groups
            //            SPgroups = SP_DefFile.Groups.ToList<DefinitionGroup>();

            //            //convert groups to strings
            //            foreach (DefinitionGroup SPgroup in SPgroups)
            //            {
            //                SPgroupstext.Add(SPgroup.Name);
            //            }

            //            //If the group doesn't exist
            //            if (SPgroupstext.Contains(groupname) == false)
            //            {
            //                //create the group
            //                DefinitionGroup QAQCgroup = SP_DefFile.Groups.Create(groupname);
            ...
            //            }
            //            //If the group exists, check if the parameter exists in shared parameter file
            //            else
            //            {
            //                //Define definition group
            //                DefinitionGroup QAQCgroup = SP_DefFile.Groups.get_Item(groupname);

            //                //Create list of shared parameter definitions
            //                SPdefinitions = QAQCgroup.Definitions.ToList<Definition>();

            //                //convert definitions to strings
            //                foreach (Definition SPdefinition in SPdefinitions)
            //                {
            //                    SPdefinitionstext.Add(SPdefinition.Name);
            //                }

            //                //If the definition doesnt exist
            //                if (SPdefinitionstext.Contains(parametername) == false)
            //                {
            //                    //write the parameters
            //                    #region write definitions and parameters
            ...
            //                //If the definition does exist.. Check if the parameter has been created, DEEPER WE MUST GO! >:P, im losing my mind with this parameter stuff
            //                else
            //                {
            //                    if (!ProjectParameterList.Contains(parametername))
            //                    {
            ...
            #region Create Column Shared Parameters
            //Structural Framing Parameter names
            ...
            #region Create VB Shared Parameters
            //Structural Framing Parameter names
            ...
            string FilenameUser = qaqcform.FilenamePublic;
            string ElementIDUser = qaqcform.ElementIDPublic;
            ...
            //IModel Imodel = ramCollectElement.InitializeRAM(Filename);
            //IStories Istories = ramCollectElement.GetStoriesRAM(Imodel);
